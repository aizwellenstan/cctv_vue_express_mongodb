<template>
  <section>
    ...
    <div class="form">
      <span class="title">Create a ID</span>
      <br>
      If you already have a ID, please <router-link to="/login" class="lightblue">sign in here</router-link>.
      <br>
      <div v-if="signingUp" />
      ...
      <form v-if="!signingUp" @submit.prevent="signup">
        ...
        <input type="checkbox" v-model="isChecked"> I agree to the
        ...
        <div style="padding-top: 21px">
          <button type="submit" class="btn-cyan">Create a ID</button>
          <router-link to="/login">
            <button class="btn-white" type="submit">Already have a ID?</button>
          </router-link>
        </div>
      </form>
    </div>
